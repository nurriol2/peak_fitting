...
def _process_ucl_area(dir, filename):
    ...
    """
    Load the frequency data from a .dat file. Then, create a DataFrame its contents.

    Args:
        dir (str): Parent directory of the frequency data.
        filename (str):  Desired frequency data file. Must be .dat suffix.

    Returns:
        (pandas.DataFrame):  DataFrame from the contents of a frequency data file.
    """
...
def _get_area(dir, filename):
    """
    Create an array of mechanical frequency values.
    ...
    Returns:
        numpy.ndarray: Mechanical frequency values as an array.
    """
    ...
    freq_values = df["mechanical_frequency"]

    return freq_values.to_numpy()
